...
## Objective
Use test-driven development to guide code changes and keep regression evidence deterministic.
...
4. Evidence
   - Record the failing test command, the passing command, and any refactor adjustments.

## Guardrails
- Never skip the red step; every change must start from a failing test.
- Keep green changes minimal.
- Run the full quality gates before handing off.
